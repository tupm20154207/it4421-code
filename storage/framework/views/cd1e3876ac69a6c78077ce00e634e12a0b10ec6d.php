...
<head>
  ...
  <script src="<?php echo e(asset('https://cdnjs.cloudflare.com/ajax/libs/core-js/2.4.1/core.js')); ?>"></script>
    ...
    <nav class="navbar navbar-expand-lg navbar-transparent text-gray navbar-absolute fixed-top ">
      <div class="container-fluid">
        <div class="navbar-wrapper">
          <a class="navbar-brand" href="#"><?php echo $__env->yieldContent('nav_title'); ?></a>
        </div>
