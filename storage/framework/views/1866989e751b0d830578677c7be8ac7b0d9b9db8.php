      ...
      <div class="col-md-10">
        <ul class="nav nav-pills mb-3 justify-content-center align-items-center" id="pills-tab" role="tablist">
          ...
          <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <li class="nav-item">
              <a class="nav-link <?php echo e($category->name == $active_category ? 'active':''); ?>" name="<?php echo e($category->name); ?>" id="pills-<?php echo e($category->name); ?>-tab" href="/menu/<?php echo e($category->name); ?>" role="tab"
  ...
  <script type="text/javascript">
    $(document).ready(function () {
      ...
      $(document).on('click', "#details_modal button[name='btn_confirm']", function () {
        ...
        $.post("<?php echo e(route('item.add')); ?>",
          {
            id: id,
            quantity: quantity,
      ...
      $(document).on('click', "#show_cart", function () {
        ...
        $.post("<?php echo e(route('cart.show')); ?>",
          {},
          function(data){
      ...
      $(document).on('click', "#cart_modal #confirm_change", function () {
        ...
        console.log(rows);
        $.post('<?php echo e(route("cart.save")); ?>', {data: rows});
        $(this).hide();
      });
